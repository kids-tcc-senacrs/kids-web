...
public post(usuario:Usuario):Observable<Response>{
	...
	let headers = new Headers({ 'Content-Type': 'application/json'});
	let options = new RequestOptions({ headers: headers });
	return this.http.post(url, usuario, options).map(this.throwResponse).catch(this.handleError);
}
...
public put(usuario:Usuario):Observable<Response>{
	...
	let headers = new Headers({ 'Content-Type': 'application/json'});
	let options = new RequestOptions({ headers: headers });
	return this.http.put(url, usuario, options).map(this.throwResponse).catch(this.handleError);
}
